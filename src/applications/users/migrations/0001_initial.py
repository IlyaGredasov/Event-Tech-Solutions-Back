    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=64, unique=True, validators=[django.contrib.auth.validators.ASCIIUsernameValidator])),
                ...
                ('vk', models.CharField(blank=True, max_length=64, null=True)),
